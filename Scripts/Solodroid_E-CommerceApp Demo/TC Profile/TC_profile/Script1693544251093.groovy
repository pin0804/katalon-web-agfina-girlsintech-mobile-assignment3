...
Mobile.tap(findTestObject('Profile/btn _Order History'), 0)

Mobile.pressBack()

Mobile.waitForElementPresent(findTestObject('Profile/btn _Order History'), 0)

WebUI.callTestCase(findTestCase('Solodroid_E-CommerceApp Demo/TC Profile/reusable-test-profile/TC Verify Element Profile'), 
    [:], FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Profile/btn_Share'), 0)

Mobile.pressBack()

Mobile.waitForElementPresent(findTestObject('Profile/btn_Share'), 0)

Mobile.tap(findTestObject('Profile/btn_Privacy Policy'), 0)

Mobile.pressBack()

Mobile.waitForElementPresent(findTestObject('Profile/btn_Privacy Policy'), 0)
