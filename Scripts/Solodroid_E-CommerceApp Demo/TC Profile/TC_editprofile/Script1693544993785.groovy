...
Mobile.verifyElementVisible(findTestObject('Profile/Edit Profile/EditText Name/btn_CANCEL'), 0)

Mobile.tap(findTestObject('Profile/Edit Profile/EditText Name/btn_OK'), 0)
